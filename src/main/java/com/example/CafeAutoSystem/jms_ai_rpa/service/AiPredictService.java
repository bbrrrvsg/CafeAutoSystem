...
public class AiPredictService {
    ...
    public PurchaseOrder createAiDraftOrder(PurchaseOrder order) {
    ...
    @Transactional(readOnly = true)
    public List<HistoricalStockLog> getHistoricalLogsByIngredient(Integer ingredientId) {
    ...
    public void saveAiAnalysisLog(Integer ingredientId, String logType, Integer amount, String message, String reason) {
        HistoricalStockLog logEntity = new HistoricalStockLog();
